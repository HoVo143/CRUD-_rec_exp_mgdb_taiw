            ...
            if(cartItems[e.id] > 0) {
              return <tr key={e.id} className='border-b border-slate-900/20 text-gray-30 p-6 medium-14 text-center'>
                <td className='flexCenter'>
                  <img src={e.image} alt="product image" height={43} width={43} className='rounded-lg ring-1 ring-slate-900/5 my-1' />
                </td>
                <td>
      ...
      <div className='flex flex-col gap-20 my-16 p-8 md:flex-row rounded-md bg-white w-full max-w-[666px]'>
        <div className='flex flex-col gap-10'>
          ...
          <div className='flex flex-col gap-10'>
            ...
            <div className='flexBetwwen pl-5 h-12 bg-primary rounded-full ring-1 ring-slate-900/10'>
